...
@Component({
  selector: 'app-reservar-lab-professor',
  templateUrl: './reservar-lab-professor.component.html',
  styleUrl: './reservar-lab-professor.component.css'
})
export class ReservarLabProfessorComponent {
  rows = [
    { nombre: 'F2-08', capacidadPersonas: '20', capacidadComputadoras: '20', facilidades: 'Proyector, pizarra, aire acondicionado', activos: 'multimetro, osciloscopio' },
    { nombre: 'F2-09', capacidadPersonas: '20', capacidadComputadoras: '20', facilidades: 'Proyector, pizarra, aire acondicionado', activos: 'multimetro, osciloscopio' },
    { nombre: 'F2-10', capacidadPersonas: '20', capacidadComputadoras: '20', facilidades: 'Proyector, pizarra, aire acondicionado', activos: 'multimetro, osciloscopio' },
    { nombre: 'F2-11', capacidadPersonas: '20', capacidadComputadoras: '20', facilidades: 'Proyector, pizarra, aire acondicionado', activos: 'multimetro, osciloscopio' },
  ];
  ...
  addRow() {
    this.rows.push({ nombre: '', capacidadPersonas: '', capacidadComputadoras: '', facilidades: '', activos: '' });
